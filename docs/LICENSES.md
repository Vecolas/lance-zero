...
| `server-only`                                     | 0.0.1                     | MIT                     | Quebra o build se um módulo de servidor for importado no cliente                                                  | https://www.npmjs.com/package/server-only                |
| `supabase/agent-skills`                           | ver `skills-lock.json`    | MIT                     | Instruções de agente para trabalhar com Supabase. Conteúdo vendorizado NÃO é versionado; o lockfile guarda o hash | https://github.com/supabase/agent-skills                 |
