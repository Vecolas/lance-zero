# ADR-0018 — O treino de final termina, e o conteúdo é conferido contra a tablebase

- **Estado:** aceito
- **Data:** 2026-09-17
- **Relacionado:** ADR-0017 (a etapa só cobra o que a tela oferece)
- **Altera:** o modelo de conteúdo de finais e a regra de cobertura do treino

## Contexto

O ADR-0017 destravou as etapas 1 a 9 da jornada de finais e declarou, como ponto
...
- **O texto continua em PT mesmo em EN**, como no ADR-0017.
