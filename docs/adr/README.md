...
| [0017](./0017-a-variacao-se-ensina-e-se-enfrenta.md)                | A variação é ensinada na posição do desvio e jogada pelo bot no treino                            | aceito, descarta a biblioteca de mini tabuleiros       |
