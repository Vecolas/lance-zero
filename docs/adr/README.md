...
| [0030](./0030-vocabulario-compartilhado-de-aberturas.md)             | O vocabulário compartilhado é contrato: id estável, sem invenção ad hoc                           | aceito, formaliza a base dos 29 cursos novos           |
| [0031](./0031-familia-grande-vira-foundation-e-cursos-filhos.md)     | Família grande vira um Foundation e cursos filhos, como a Siciliana                               | aceito, aplica o ADR-0025 a famílias sem fim           |
| [0032](./0032-portoes-obrigatorios-de-autoria-de-abertura.md)        | Os portões de autoria, e a regra de que o escopo da asserção é o do contrato                      | aceito, nasce de dois portões que mediam outra coisa   |
