...
import { atualizarProgresso, desserializarProgressoDeFinais, estadoInicialDeFinal, registrarResultadoDeFinais, selecionarPosicaoAdaptativa, serializarProgressoDeFinais } from '@/domain/endgames'
...
describe('progresso multidimensional de finais', () => {
  ...
  it('seleciona posição adaptativa com desempate determinístico', () => {
    const set = { id: 'x', endgameId: 'x', positions: [{ id: 'b', fen: '8/8/8/8/8/8/4K3/4k3 w - - 0 1', sideToTrain: 'white' as const, objective: 'win' as const, conceptIds: ['x'], validationSource: 'curated' as const, difficulty: 2 }, { id: 'a', fen: '8/8/8/8/8/8/4K3/4k3 w - - 0 1', sideToTrain: 'white' as const, objective: 'win' as const, conceptIds: ['x'], validationSource: 'curated' as const, difficulty: 2 }] }
